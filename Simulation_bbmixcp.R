...
#----------------------#
# true Observed trends #
#----------------------#

dat<-data.frame(y=y,t=t,tx=tx,C=C,id=id)

yobs<-dat%>%
  group_by(C,tx,t,.add = TRUE)%>%
  dplyr::summarize(yobs=mean(y))

yc1<-yobs[yobs$C==1,]  # Observed y class 1
yc2<-yobs[yobs$C==2,]  # Observed y class 2
yc3<-yobs[yobs$C==3,]  # Observed y class 3

dplotc0<-data.frame(gp=rep(c(1,2,3,4,5,6),each=12),
                    yobs=c(yc1[yc1$tx==0,]$yobs,yc1[yc1$tx==1,]$yobs,
                           yc2[yc2$tx==0,]$yobs,yc2[yc2$tx==1,]$yobs,
                           yc3[yc3$tx==0,]$yobs,yc3[yc3$tx==1,]$yobs),
                    t=rep(1:12,6))

dplotc0$gp<-factor(dplotc0$gp,levels=c(1,2,3,4,5,6),labels=c("Class 1 - Placebo","Class 1 - Varenicline",
                                                             "Class 2 - Placebo","Class 2 - Varenicline",
                                                             "Class 3 - Placebo","Class 3 - Varenicline"))

dplotc0$class<-factor(rep(1:3,each=24),levels=c(1,2,3),labels=c("Class 1","Class 2","Class 3"))


ggplot(dplotc0,aes(x=t,y=yobs,shape=gp,color=gp))+
  geom_point()+
  geom_line()+
...
plot_c1=ggplot(dplotc0_c1,aes(x=t,y=y,shape=gp,color=gp))+
  ...
  geom_vline(aes(xintercept=7,col="Changepoint - Placebo"),linetype=3,linewidth=1.5,show.legend = F)+
  geom_vline(aes(xintercept=7,col="Changepoint - Varenicline"),linetype=3,linewidth=1.5,show.legend = F)+
  xlab("Week")+ylab("Mean abstinent days")+
  scale_x_continuous(breaks = 1:12)+scale_y_continuous(limits = c(0,7),breaks = seq(0,7,by=1))+
...
plot_c2=ggplot(dplotc0_c2,aes(x=t,y=y,shape=gp,color=gp))+
  geom_line(linewidth=1.5)+
  geom_vline(aes(xintercept=5,col="Changepoint - Placebo"),linetype=3,linewidth=1.5,show.legend = F)+
  geom_vline(aes(xintercept=6,col="Changepoint - Varenicline"),linetype=3,linewidth=1.5,show.legend = F)+
  xlab("Week")+ylab("Mean abstinent days")+
  scale_x_continuous(breaks = 1:12)+scale_y_continuous(limits = c(0,7),breaks = seq(0,7,by=1))+
...
plot_c3=ggplot(dplotc0_c3,aes(x=t,y=y,shape=gp,color=gp))+
  geom_line(linewidth=1.5)+
  geom_vline(aes(xintercept=6,col="Changepoint - Placebo"),linetype=3,linewidth=1.5,show.legend = F)+
  geom_vline(aes(xintercept=8,col="Changepoint - Varenicline"),linetype=3,linewidth=1.5,show.legend = F)+
  xlab("Week")+ylab("Mean abstinent days")+
  scale_x_continuous(breaks = 1:12)+scale_y_continuous(limits = c(0,7),breaks = seq(0,7,by=1))+
...
ggarrange(plot_c1,plot_c2,plot_c3,
          ncol=1,nrow=3)
